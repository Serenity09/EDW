library EDWLevels requires LevelIDGlobals, Levels, PW4
	public function Initialize takes nothing returns nothing
        ...
        //LEVEL 1
        set l = Levels_Level.create(IW1_LEVEL_ID, 3, 2, "IW1Start", "IW1Stop", gg_rct_IWR_1_1, gg_rct_IW1_Vision, gg_rct_IW1_End, 0)
        call l.AddCheckpoint(gg_rct_IWCP_1_1, gg_rct_IWR_1_2)
		
		//LEVEL 2
        set l = Levels_Level.create(IW2_LEVEL_ID, 4, 3, "IW2Start", "IW2Stop", gg_rct_IWR_2_1, gg_rct_IW2_Vision, gg_rct_IW2_End, l)
		...
		//LEVEL 4
        set l = Levels_Level.create(IW4_LEVEL_ID, 6, 4, "IW4Start", "IW4Stop", gg_rct_IWR_4_1, gg_rct_IW4_Vision, gg_rct_IW4_End, l)
		...
		//ICE WORLD B
		//LEVEL 1
		set l = Levels_Level.create(IWB1_LEVEL_ID, 4, 2, "IWB1Start", "IWB1Stop", gg_rct_EIWR_1_1, gg_rct_EIW1_Vision, gg_rct_EIW1_End, 0)
        ...
        //LEVEL 1
        set l = Levels_Level.create(PW1_LEVEL_ID, 4, 2, "PW1Start", "PW1Stop", gg_rct_PWR_1_1, gg_rct_PW1_Vision, gg_rct_PW1_End, 0) //gg_rct_PW1_Vision
		...
		//LEVEL 3
        set l = Levels_Level.create(PW3_LEVEL_ID, 5, 4, "PW3Start", "PW3Stop", gg_rct_PWR_3_1, gg_rct_PW3_Vision, gg_rct_PW3_End, l) //gg_rct_PW1_Vision
		...
		//LEVEL 4
		if CONFIGURATION_PROFILE != RELEASE then
			set l = Levels_Level.create(PW4_LEVEL_ID, 5, 4, "PW4Start", "PW4Stop", gg_rct_PWR_4_1, gg_rct_PW4_Vision, gg_rct_PW4_End, l) //gg_rct_PW1_Vision
		...
		set l = Levels_Level.create(FS1_LEVEL_ID, 3, 2, "FourSeason1Start", "FourSeason1Stop", gg_rct_FSR_1_1, gg_rct_FS1_Vision, gg_rct_FS1_End, 0)
        ...
        //Testing worlds
        set l = Levels_Level.create(TESTDH_LEVEL_ID, 0, 0, null, null, gg_rct_SWR_2_1, null, null, 0)
		
		set l = Levels_Level.create(TESTP_LEVEL_ID, 0, 0, null, null, gg_rct_SWR_1_1, null, null, 0)
        set Checkpoint(l.Checkpoints.first.value).DefaultGameMode = Teams_GAMEMODE_PLATFORMING
	endfunction
endlibrary