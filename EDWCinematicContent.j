library EDWCinematicContent requires EDWLevelContent, Cinema, EDWGameTime
	...
	public function Initialize takes nothing returns nothing
        ...
        */
        ...
        set cineMsg = CinemaMessage.createEx(null, "Phil", 'I1P1', DEFAULT_MEDIUM_TEXT_SPEED)
        set cine = Cinematic.create(gg_rct_IW1Runes, true, true, cineMsg)
        call cine.AddMessage(CinemaMessage.createEx(null, "Marge (lost forever to the Oblivion)", 'I1M1', DEFAULT_MEDIUM_TEXT_SPEED))
        call cine.AddMessage(CinemaMessage.createEx(null, "Phil", 'I1P2', DEFAULT_SHORT_TEXT_SPEED))
		call cine.AddMessage(CinemaMessage.createEx(null, "Phil", 'I1P3', DEFAULT_SHORT_TEXT_SPEED))
        call cine.SetLastMessageBuffer(-1)
		call Levels_Level(3).AddCinematic(cine)
		
		set cineMsg = CinemaMessage.createEx(null, "Bobby", 'I1B1', DEFAULT_LONG_TEXT_SPEED)
        ...
        // call cine.AddMessage(CinemaMessage.createEx(null, "Bobby", 'I1B3', DEFAULT_SHORT_TEXT_SPEED + .5))
		call cine.AddMessage(CinemaMessage.createEx(null, "Little Timmy", 'I1T1', DEFAULT_TINY_TEXT_SPEED))
		...
		call cine.AddMessage(CinemaMessage.createEx(null, "Little Timmy", 'I1T4', DEFAULT_MEDIUM_TEXT_SPEED))
		call cine.AddMessage(CinemaMessage.createEx(null, "Little Timmy", 'I1T5', DEFAULT_LONG_TEXT_SPEED))
        call cine.SetLastMessageBuffer(-1)
		call Levels_Level(3).AddCinematic(cine)
		
		set cineMsg = CinemaMessage.create(null, GetEDWSpeakerMessage("Becky", "...", null), DEFAULT_SHORT_TEXT_SPEED)
		...
		set cineMsg = CinemaMessage.createEx(null, "Bobby", 'I1b1', DEFAULT_SHORT_TEXT_SPEED)
        ...
        set cineMsg = CinemaMessage.createEx(null, "Little Timmy", 'I2T1', DEFAULT_SHORT_TEXT_SPEED)
		...
		call cine.AddMessage(CinemaMessage.createEx(null, "Little Timmy", 'I3T1', DEFAULT_TINY_TEXT_SPEED))
		call cine.AddMessage(CinemaMessage.createEx(null, "Little Timmy", 'I3T2', DEFAULT_SHORT_TEXT_SPEED))
		call cine.AddMessage(CinemaMessage.createEx(null, "Little Timmy", 'I3T3', DEFAULT_SHORT_TEXT_SPEED))
