library PlatformerIce initializer Init requires SimpleList, PlatformerGlobals
    globals
        ...
        public real SLOW_MAX_VELOCITY = DIAGONAL_MAXCHANGE / 2
        ...
        public real FAST_VELOCITY = 25 * TIMESTEP
        public real FAST_MAX_VELOCITY = DIAGONAL_MAXCHANGE / 1.5
    ...
    private function Loop takes Platformer p returns nothing        
		...
		//debug call DisplayTextToForce(bj_FORCE_PLAYER[0], "Before ice physics ---")
        //design concept:
		...
		//debug call DisplayTextToForce(bj_FORCE_PLAYER[0], "After ice physics ---")
